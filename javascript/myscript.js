...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Chết tiệt tim anh đập nhanh vl haiz " + (thePercent+2900);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Chết mất thôi aaaa:';
document.querySelector('.Description .modal-body').innerHTML = 'Anh thương em đó Minh Ngọc <i class="fas fa-heart"></i> ';
;
